...
public class AdminControllerV1Test {
    @Autowired
    ...
    @Test
    @DisplayName("DELETE /v1/admin/cache/clear - Should call clear() and return 200 OK")
    void testClear_Success() throws Exception {
        ...
        mockMvc.perform(delete("/v1/admin/cache/clear"))
    ...
    @Test
    @DisplayName("DELETE /v1/admin/cache/clear - Should call clear() and return 500 Internal Server Exception")
    ...
    @Test
    @DisplayName("DELETE /v1/admin/cache/remove/all - Should call removeAll() and return 200 OK")
    void testRemoveAll_Success() throws Exception {
        ApiResponseEnvelop<String> successResponse = ApiResponseEnvelop.success("OK");
        when(cacheService.removeAll()).thenReturn(successResponse);

        mockMvc.perform(delete("/v1/admin/cache/remove/all"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status").value("SUCCESS"))
                .andExpect(jsonPath("$.data").value("OK"));
    ...
    @Test
    @DisplayName("DELETE /v1/admin/cache/remove/all - Should call removeAll() and return 500 Internal Server Exception")
